...
<head>
	...
	<script src="http://localhost/Unisole/asset/js/alertify.js"></script>
	<link rel="stylesheet" type="text/css" href="http://localhost/Unisole/asset/css/register.css">
	<link rel="stylesheet" type="text/css" href="http://localhost/Unisole/asset/css/alertify.core.css">
	<link rel="stylesheet" type="text/css" href="http://localhost/Unisole/asset/css/alertify.default.css" id="toggleCSS">
</head>
<body>
	<header>
	...
	<div id="login-box">
		<div class="left">
			...
			<form action="http://localhost/Unisole/Controller-client/User_Controller.php" method="POST" name="myForm" ">
	...
	<script type="text/javascript" >
		...
		$('#username').blur(function(){
			$.ajax({
					url: "http://localhost/Unisole/Controller-client/check-course-account.php",
					type: "POST",
					data: {
