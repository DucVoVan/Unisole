...
<div class="mark-point">
	<table>
		...
		<tr>
			...
			<td><input type="number" value="0" min="0" max="10" name="24-1"></td>
			<td><input type="number" value="10" min="0" max="10" name="24-2"></td>
		...
		<tr>
			...
			<td><input type="number" value="0" min="0" max="10" name="25-1"></td>
			<td><input type="number" value="10" min="0" max="10" name="25-2"></td>
		...
		<tr>
			...
			<td><input type="number" value="0" min="0" max="10" name="26-1"></td>
			<td><input type="number" value="10" min="0" max="10" name="26-2"></td>
		...
		<tr>
			...
			<td><input type="number" value="0" min="0" max="10" name="27-1"></td>
			<td><input type="number" value="10" min="0" max="10" name="27-2"></td>
		...
		<tr>
			...
			<td><input type="number" value="0" min="0" max="10" name="28-1"></td>
			<td><input type="number" value="10" min="0" max="10" name="28-2"></td>
		...
		<tr>
			...
			<td><input type="number" value="0" min="0" max="10" name="29-1"></td>
			<td><input type="number" value="10" min="0" max="10" name="29-2"></td>
		...
		<tr>
			...
			<td><input type="number" value="0" min="0" max="10" name="30-1"></td>
			<td><input type="number" value="10" min="0" max="10" name="30-2"></td>
		...
		<tr>
			...
			<td><input type="number" value="0" min="0" max="10" name="31-1"></td>
			<td><input type="number" value="10" min="0" max="10" name="31-2"></td>
...
<script type="text/javascript">
	...
	$('.mark').on('click',function(){
		...
		if(count==0){
			$.ajax({
				url: "http://localhost/Unisole/control-admin-views/AddPoint.php",
				type: "POST",
				dataType: "text",
				data: {
					accountid: a,
