(function($){
	...
	$('.part-1').on('click', function(){
		...
		$('.conn-1-1').empty();
		$.ajax({
			url: "http://localhost/Unisole/Controller-client/User_Controller.php",
			type: "POST",
			dataType: "json",
			data: {
	...
	$('.conn-1-1').on('click','.topic-child-id', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				$('.conn-1-2').append('<script src="http://localhost/Unisole/asset/js/pickcourse3.js"></script>');
			}
		});
	...
	$('.conn-2-1').on('click','.topic-child-id', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				$('.conn-2-2').append('<script src="http://localhost/Unisole/asset/js/pickcourse3.js"></script>');
			}
		});
	...
	$('.conn-3-1').on('click','.topic-child-id', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				$('.conn-3-2').append('<script src="http://localhost/Unisole/asset/js/pickcourse3.js"></script>');
			}
		});
