...
$('form').on('submit',function(){
	...
	else if (isEmpty(value21))
	{
		...
		if(confirm("Bạn đã chắc chắn về các lựa chọn của mình! Bấm Ok để hoàn thành!")){
			$.ajax({
				url: "http://localhost/Unisole/Controller-client/BandupdateCtr.php",
				type: "POST",
				data: {
					question0: link,
					question1: save1,
				...
				success: function(data){
					if(data=="exits"){
						...
						swal({
							title: "Thông báo!",
							html: 'Hoàn thành! Vui lòng chờ quản trị viên của chúng tôi xét duyệt lại! Khi việc xét duyệt thành công, bạn sẽ nhận được thông báo và Band của bạn sẽ được giới thiệu trên trang <a href="http://localhost/Unisole/view-client/Band.php">Band nhạc</a>',
							type: "success",
							confirmButtonText: 'OK',
						});
					}else{
