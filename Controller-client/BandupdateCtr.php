<?php 
	...
	$sql = "UPDATE `band` SET `status`=0,`question0`='$question0',`question1`='$question1',`question2`='$question2',`question3`='$question3',`question4`='$question4',`question5`='$question5',`question6`='$question6',`question7`='$question7',`question8`='$question8',`question9`='$question9',`question10`='$question10',`question11`='$question11',`question12`='$question12',`question13`='$question13',`question14`='$question14',`question15`='$question15',`question16`='$question16',`question17`='$question17',`question18`='$question18',`question19`='$question19',`question20`='$question20',`question21`='$question21' WHERE `accountid`='$account_id'";
